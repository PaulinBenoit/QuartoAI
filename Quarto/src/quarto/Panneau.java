...
public class Panneau extends JPanel {
    ...
    public final int TAILLE_CASE = 150;
    public final int MARGIN_PLATEAU = 30;
    public final int TAILLE_GRANDE_PIECE = 120;
    public final int TAILLE_PETITE_PIECE = 90;
    public final int MARGIN_PIECE = 50;
    public final int MARGIN_INFOS = 50;
    public final int HEIGHT_INFOS = 80;
    public final int WIDTH_INFOS = 480;
    ...
    public void paintComponent(Graphics g) {
        ...
        //INFOS
        int marginInfosX = MARGIN_PLATEAU + (TAILLE_CASE * 4) + MARGIN_INFOS;
        int marginInfosY = MARGIN_PIECE + (TAILLE_GRANDE_PIECE * 4) + MARGIN_INFOS;
        g.drawRect(marginInfosX, marginInfosY, WIDTH_INFOS, HEIGHT_INFOS);
    }
}
